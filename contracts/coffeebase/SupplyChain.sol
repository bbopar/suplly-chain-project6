...
contract SupplyChain is Ownable, FarmerRole, DistributorRole, RetailerRole, ConsumerRole {
  ...
  modifier sold(uint _upc) {
    require(items[_upc].itemState == State.Sold, "avabilable for sale");
    _;
  }
  ...
  modifier purchased(uint _upc) {
    require(items[_upc].itemState == State.Purchased, "not pruchased");
    _;
  }
    ...
    onlyFarmer
  {
    ...
    Item memory item  = Item({
      ...
      consumerID: payable(0x0000000000000000000000000000000000000000)
    });
    items[_upc] = item;
    // Increment sku
    sku = sku + 1;
  ...
  function purchaseItem(uint _upc) public 
    ...
    items[_upc].consumerID = payable(customer);
